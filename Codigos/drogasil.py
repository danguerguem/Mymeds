...
def salvar_produtos_dinamicamente(produtos_pagina):
    caminho_arquivo = "C:/Users/danie/OneDrive/Desktop/Mymeds/meu-projeto/data/p_drogasil.json"
...
def run():
    with sync_playwright() as p:
        ...
        base_url = "https://www.drogasil.com.br/medicamentos/medicamentos.html"
        ...
        while True:
            ...
            for i in range(products.count()):
                ...
                produto_data = {
                    ...
                    "imagem": "https://www.drogasil.com.br" + imagem
                }
